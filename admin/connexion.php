...
<body>
    <div class="col-12 content bodyConnexion">
            ...
            <section>
                <form method="post" action="">
                    <div class="arkalogin">
                        ...
                        <input class="giris" type="text" name="ndc" placeholder="User">
                        <input class="giris" type="password" name="password" placeholder="•••••">
                        <a href="https://dogukankeskin.com" target="blank"><input class="butonlogin" type="submit" name="admin_connection" value="Valider"></a>
                    </div>
                </form>
                <?php
